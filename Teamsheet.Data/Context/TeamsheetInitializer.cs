...
{
    public class TeamsheetInitializer : DropCreateDatabaseAlways<TeamsheetContext>
    {
        protected override void Seed(TeamsheetContext context)
        {
            IList<Country> defaultCountries = new List<Country>();

            foreach(var country in GetAllCountries())
            {
                defaultCountries.Add(new Country()
                {
                    Name = country
                });
            }
